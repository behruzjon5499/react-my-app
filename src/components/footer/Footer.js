                                    ...
                                    <div className="f_widget company_widget wow fadeInLeft" data-wow-delay="0.2s"
                                        ...
                                        <form  className="f_subscribe_two mailchimp"
                                            ...
                                            <input type="text" name="EMAIL" className="form-control memail"
                                                   placeholder="Email"/>
                                                <button className="btn btn_get btn_get_two" type="submit">Subscribe
                                                </button>
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-lg-6 col-sm-7">
                                    <p className="mb-0 f_400">© cakecounter Inc.. 2021 All rights reserved.</p>
                                </div>
                                <div className="col-lg-6 col-sm-5 text-right">
                                    <p>Made from by <i className="icon_heart"/>  <a href="http://cakecounter.com"
                                                                                      target="_blank">bekhruzjon</a>
                                    </p>
                                </div>
                            </div>
                        </div>
